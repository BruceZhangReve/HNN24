...
do
    python train.py \
    --lr 1e-3 --dropout 0.2 --cuda 7 --epochs 5000 --weight_decay 5e-4 --optimizer radam --momentum 0.999 --patience 50 --seed 7 --log_freq 10 --eval_freq 10 --save 1 --save_dir None --sweep_c 0 --lr_reduce_freq 100 --gamma 0.5 --print_epoch True --grad_clip None --min_epochs 100 \
    --use_geoopt False --AggKlein True --corr 1 --nei_agg 0 --task nc --model BKNet --dim 32 --manifold PoincareBall --c 1.0 --r 2.0 --t 1.0 --margin 2.0 --pretrained_embeddings None --pos_weight 0 --num_layers 2 --bias 1 --act relu --n_heads 4 --alpha 0.2 --double_precision 1 --use_att 0 --local_agg 0 --kernel_size $kernel_size --KP_extent 0.66 --radius 1 --deformable False --linear_before 32 \
    ...
    python train.py \
    --lr 1e-3 --dropout 0.2 --cuda 7 --epochs 5000 --weight_decay 5e-4 --optimizer radam --momentum 0.999 --patience 50 --seed 28 --log_freq 10 --eval_freq 10 --save 1 --save_dir None --sweep_c 0 --lr_reduce_freq 100 --gamma 0.5 --print_epoch True --grad_clip None --min_epochs 100 \
    --use_geoopt False --AggKlein True --corr 1 --nei_agg 0 --task nc --model BKNet --dim 32 --manifold PoincareBall --c 1.0 --r 2.0 --t 1.0 --margin 2.0 --pretrained_embeddings None --pos_weight 0 --num_layers 2 --bias 1 --act relu --n_heads 4 --alpha 0.2 --double_precision 1 --use_att 0 --local_agg 0 --kernel_size $kernel_size --KP_extent 0.66 --radius 1 --deformable False --linear_before 32 \
...
do
    ...
    python train.py \
    --lr 1e-3 --dropout 0.2 --cuda 7 --epochs 5000 --weight_decay 5e-4 --optimizer radam --momentum 0.999 --patience 50 --seed 8 --log_freq 10 --eval_freq 10 --save 1 --save_dir None --sweep_c 0 --lr_reduce_freq 100 --gamma 0.5 --print_epoch True --grad_clip None --min_epochs 100 \
    --use_geoopt False --AggKlein True --corr 1 --nei_agg 0 --task nc --model BKNet --dim 32 --manifold PoincareBall --c 1.0 --r 2.0 --t 1.0 --margin 2.0 --pretrained_embeddings None --pos_weight 0 --num_layers 2 --bias 1 --act relu --n_heads 4 --alpha 0.2 --double_precision 1 --use_att 0 --local_agg 0 --kernel_size $kernel_size --KP_extent 0.66 --radius 1 --deformable False --linear_before 32 \
...
do
    ...
    python train.py \
    --lr 1e-3 --dropout 0.2 --cuda 7 --epochs 5000 --weight_decay 5e-4 --optimizer radam --momentum 0.999 --patience 50 --seed 10 --log_freq 10 --eval_freq 10 --save 1 --save_dir None --sweep_c 0 --lr_reduce_freq 100 --gamma 0.5 --print_epoch True --grad_clip None --min_epochs 100 \
    --use_geoopt False --AggKlein True --corr 1 --nei_agg 0 --task nc --model BKNet --dim 32 --manifold PoincareBall --c 1.0 --r 2.0 --t 1.0 --margin 2.0 --pretrained_embeddings None --pos_weight 0 --num_layers 2 --bias 1 --act relu --n_heads 4 --alpha 0.2 --double_precision 1 --use_att 0 --local_agg 0 --kernel_size $kernel_size --KP_extent 0.66 --radius 1 --deformable False --linear_before 32 \
...
do
    python train.py \
    --lr 1e-3 --dropout 0.65 --cuda 7 --epochs 5000 --weight_decay 1e-4 --optimizer radam --momentum 0.999 --patience 250 --seed 9 --log_freq 10 --eval_freq 10 --save 1 --save_dir None --sweep_c 0 --lr_reduce_freq 500 --gamma 0.5 --print_epoch True --grad_clip 0.5 --min_epochs 100 \
    ...
    python train.py \
    --lr 1e-3 --dropout 0.65 --cuda 7 --epochs 5000 --weight_decay 1e-4 --optimizer radam --momentum 0.999 --patience 250 --seed 20 --log_freq 10 --eval_freq 10 --save 1 --save_dir None --sweep_c 0 --lr_reduce_freq 500 --gamma 0.5 --print_epoch True --grad_clip 0.5 --min_epochs 100 \
    --use_geoopt True --AggKlein False --corr 1 --nei_agg 0 --task nc --model HKPNet --dim 32 --manifold Lorentz --c 1.0 --r 2.0 --t 1.0 --margin 2.0 --pretrained_embeddings None --pos_weight 0 --num_layers 2 --bias 1 --act relu --n_heads 4 --alpha 0.2 --double_precision 1 --use_att 0 --local_agg 0 --kernel_size $kernel_size --KP_extent 0.66 --radius 1 --deformable False --linear_before 32 \
