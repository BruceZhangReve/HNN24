...
#Run via BKN
python train.py \
    --lr 1e-3 --dropout 0.3 --cuda 7 --epochs 1000 --weight_decay 1e-3 --optimizer radam --momentum 0.999 --patience 15 --seed 18 --log_freq 2 --eval_freq 2 --save 1 --save_dir None --sweep_c 0 --lr_reduce_freq None --gamma 0.5 --print_epoch True --grad_clip None --min_epochs 300 \
    ...
    --dataset film --batch_size 32 --val_prop 0.05 --test_prop 0.1 --use_feats 1 --normalize_feats 1 --normalize_adj 1 --split_seed 28 --split_graph False
